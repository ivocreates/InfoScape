        ...
        <div className="p-6">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
            ...
            <div>
              ...
              {/* Predefined Proxies */}
              <div className="mb-4">
                <label className="text-sm font-medium text-gray-700 dark:text-gray-300 mb-2 block">Predefined Proxies</label>
                <div className="space-y-2">
                  {Object.entries(predefinedProxies).map(([key, proxy]) => (
                    <button
                      key={key}
                      onClick={() => handlePredefinedProxy(key)}
                      className="w-full p-2 text-left border border-gray-200 dark:border-gray-600 rounded hover:border-gray-300 dark:hover:border-gray-500 transition-colors bg-white dark:bg-gray-800"
                    >
                      <div className="font-medium text-gray-900 dark:text-gray-100">{proxy.name}</div>
                      <div className="text-xs text-gray-500 dark:text-gray-400">{proxy.host}:{proxy.port} ({proxy.type})</div>
                    </button>
                  ))}
                </div>
              </div>
              ...
              <div className="space-y-4">
                <div className="flex items-center gap-2">
                  ...
                  />
                  <label htmlFor="enableProxy" className="text-sm font-medium text-gray-700 dark:text-gray-300">
                    Enable Custom Proxy
                  </label>
                </div>
                ...
                {proxyConfig.enabled && (
                  <div className="space-y-3 p-4 bg-gray-50 dark:bg-gray-800 rounded-lg">
                    <div className="grid grid-cols-2 gap-3">
                      ...
                      <div>
                        <label className="text-sm font-medium text-gray-700 dark:text-gray-300 mb-1 block">Host</label>
                        <input
                          type="text"
